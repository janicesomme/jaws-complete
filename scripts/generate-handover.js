 ...
 *
 * Generates plain English HANDOVER-CHECKLIST.md from a PRD using Claude API
 *
 * Usage:
 *   node scripts/generate-handover.js <path-to-prd.md>
 *   node scripts/generate-handover.js jaws-analytics/PRD.md
 */
...
if (!prdPath) {
  ...
  console.error('Usage: node scripts/generate-handover.js <path-to-prd.md>');
  process.exit(1);
}
...
const outputPath = path.join(outputDir, 'HANDOVER-CHECKLIST.md');
const promptPath = path.join(__dirname, '..', 'prompts', 'owner-manual', 'handover-prompt.md');

console.log('=== HANDOVER-CHECKLIST.md Generator ===\n');
...
// Call Claude API
console.log('Calling Claude API to generate handover checklist...');
console.log('');
...
const req = https.request(options, (res) => {
  ...
  res.on('end', () => {
    ...
    try {
      ...
      console.log('✓ Generated HANDOVER-CHECKLIST.md successfully!');
      console.log('');
      ...
      console.log('');
      console.log('Next: Review the handover checklist and customize contact information before delivery!');
